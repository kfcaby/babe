...
In 1921, Babe Ruth hit 59 home runs with an on-base percentage plus slugging (OPS) of 1.359.  It was an exceptional season with no other players coming close to matching these numbers until Bonds, Sosa, and McGwire in the late 1990s. Figure 1 depicts OPS versus home runs for every Major League hitter by season with at least 502 plate appearances.  All calculations were performed in R using data publicly available in the Lahman package (Lahman, 2019; Friendly 2020).   Only six players (Ruth, Williams, Maris, Sosa, McGwire, and Bonds) have seasons in which they hit at least 60 home runs or had an OPS greater than 1.250.  Barry Bonds' 2001 season is the only one in which a player hit more home runs and had a higher OPS than Ruth's 1921 season.    
